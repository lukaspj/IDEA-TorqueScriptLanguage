...
"""
    ...
    companion object {
        private val DESCRIPTORS = arrayOf(
            ...
            AttributesDescriptor("Builtin function call", TSSyntaxHighlightingColors.BUILTIN_FUNCTION_CALL),
            AttributesDescriptor("Object name", TSSyntaxHighlightingColors.OBJECT_NAME),
            AttributesDescriptor("Builtin object name", TSSyntaxHighlightingColors.BUILTIN_OBJECT_NAME),
            AttributesDescriptor("Class name", TSSyntaxHighlightingColors.CLASS_NAME),
            AttributesDescriptor("Builtin class name", TSSyntaxHighlightingColors.BUILTIN_CLASS_NAME),
